#!/bin/sh
python3 Optimisation.py -e 76 -s existing -y no_import -p 10 -i 1000 running
...
python3 Optimisation.py -e 76 -s construction -y no_import -p 10 -i 1000
...
python3 Optimisation.py -e 76 -s all -y no_import -p 10 -i 1000
